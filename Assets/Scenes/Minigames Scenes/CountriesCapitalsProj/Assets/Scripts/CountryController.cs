...
public class CountryController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        FindObjectOfType<CCUIDisplay>().SetAmoutLoseText(amountPassed.ToString());
    }
    ...
    void Update()
    {
        CheckCountries();
        print(amountPassed);
        if (amountPassed >=10 || FindObjectOfType<MiniGameSession>().GetScore()>=10)
        {
